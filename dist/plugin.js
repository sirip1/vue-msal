...
var msalPlugin = /** @class */ (function () {
    function msalPlugin(options, Vue) {
        ...
        var exposed = {
            data: msal.data,
            signIn: function (loginHint) { msal.signIn(loginHint); },
            signOut: function () {
            ...
            setOnTokenCallback: function (cb) { msal.setOnTokenCallback(cb); },
            setOnAuthenticationCallback: function (cb) { msal.setOnAuthenticationCallback(cb); }
        };
        return exposed;
    }
